...
class QuestionViewController: UIViewController {
    ...
    var list = [
        ...
        Question(questionStr: "목표 체중 등록은 어떻게 하나요??", answerStr: "그래프 화면 우측 상단에 '+' 버튼을 누르시면 등록이 가능합니다.", isExpand: false),
        Question(questionStr: "신체정보 삭제는 어떻게 하나요?", answerStr: "잘", isExpand: false)
    ]
